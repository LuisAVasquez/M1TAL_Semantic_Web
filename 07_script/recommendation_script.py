...
######
dictionaries_path = "/home/luisv/LCT.Lorraine/Semester2/TheSemanticWeb/Project/Code/03_parsing_labels/dictionaries/"
...
def input_user_platform(name):
    ...
    while count < max_count:
        ...
        print("{name}, which of these platforoms do you have? (write the index)".format(name = name))
        print("write 'none' to get a new list!")
        idx = custom_ask("")
